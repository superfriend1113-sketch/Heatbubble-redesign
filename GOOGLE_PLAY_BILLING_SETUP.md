...
1. Create the subscription with the above details
2. Under **"Add a base plan"** → Billing period: Monthly, Price: $1.99
3. Under **"Add an offer"** → Introductory offer: Free trial, Duration: 7 days
4. Set eligibility to **"New subscribers only"** (one trial per Google account)
5. Activate the base plan and the offer
...
| **Description** | Full access to all premium features for a full year. Auto-renews annually. |
...
**Setup steps in Play Console:**
1. Create the subscription with the above details
2. Under **"Add a base plan"** → Billing period: 12 months, Price: $19.99
3. Under **"Add an offer"** → Introductory offer: Free trial, Duration: 7 days
4. Set eligibility to **"New subscribers only"**
5. Activate the base plan and the offer

> ⚠️ **Important**: The annual plan **auto-renews every year** (not a one-time purchase). Google Play will charge $19.99 again after 12 months unless the user cancels. This is the standard Play Store annual subscription behaviour.

> ⚠️ **Products must be activated** before they appear in the app. Wait 2–4 hours after activation.
