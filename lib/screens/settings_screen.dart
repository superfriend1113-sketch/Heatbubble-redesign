            ...
            _glassCard(
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(LucideIcons.testTube, size: 18, color: Color(0xFF111827)),
                      const SizedBox(width: 8),
                      const Text(
                        'Test Notifications',
                        style: TextStyle(
                  ...
                  const SizedBox(height: 12),
                  Text(
                    'Test notification messages with your selected temperature unit',
                    style: TextStyle(
                      fontSize: 13,
                      color: Colors.grey[600],
                    ),
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: OutlinedButton.icon(
                          onPressed: () async {
                            await NudgeService().testTrendNotification();
                            _showMessage('Test notification sent! Check your notification tray.', isError: false);
                          },
                          icon: const Icon(LucideIcons.trendingUp, size: 16),
                          label: const Text('Trend Alert'),
                          style: OutlinedButton.styleFrom(
                            side: const BorderSide(color: Color(0xFF111827)),
                            foregroundColor: const Color(0xFF111827),
                          ),
                      ...
                      Expanded(
                        child: OutlinedButton.icon(
                          onPressed: () async {
                            await NudgeService().testComparisonNotification();
                            _showMessage('Test notification sent! Check your notification tray.', isError: false);
                          },
